var fs = require('fs'),
	...
	fctName = path.join(__dirname, 'factors.json'),
	fctTable = JSON.parse(fs.readFileSync(fileName, 'utf8'));
...
exports.factorize = function(n) {
	if(n > fctTable.N) {
		exports.makeFctTable(n);
		fctTable = JSON.parse(fs.readFileSync(fctName, 'utf8'));
	}
